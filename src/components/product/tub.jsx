...
function Tub(){
    ...
    // function AddCart(e){
    //     if (log === log) {
    //         localStorage.setItem("Alu",JSON.stringify(["plastic"]))
    //     }else{
    //         alert("Login First")
    //     }
            ...
            <div className="shopMain">
                <div className="shopUp">
                    ...
                    <div className="shopUpLeft">
                        ...
                        <p>The plastic cylinder planters come with a wooden stand to help elevate your plants off the ground. The plastic cylinder planters come with a wooden stand to help elevate your plants off the ground. </p>
                        <button className="shopBtn">Add to cart</button>
                        <p className="hollow">SKU: 1995751877966</p>
                        <p className="hollow">Categories: Household Items</p>
                        <p className="hollow">Tags: Home, Garden, Plants</p>
                    </div>
                </div>
                <div className="shopDown">
                    <h2 >Product Description</h2>
                    <p>The plastic cylinder planters come with a wooden stand to help elevate your plants off the ground. The plastic cylinder planters come with a plastic stand to help elevate your plants off the ground. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla augue nec est tristique auctor. Donec non est at libero vulputate rutrum. Morbi ornare lectus quis justo gravida semper. Nulla tellus mi, vulputate adipiscing cursus eu, suscipit id nulla.</p>
                    <p>Pellentesque aliquet, sem eget laoreet ultrices, ipsum metus feugiat sem, quis fermentum turpis eros eget velit. Donec ac tempus ante. Fusce ultricies massa massa. Fusce aliquam, purus eget sagittis vulputate, sapien libero hendrerit est, sed commodo augue nisi non neque. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lorem et placerat vestibulum, metus nisi posuere nisl, in accumsan elit odio quis mi. Cras neque metus, consequat et blandit et, luctus a nunc. Etiam gravida vehicula tellus, in imperdiet ligula euismod eget. The plastic cylinder planters come with a wooden stand to help elevate your plants off the ground. </p>
                    <h4 className="shopDownMain">Living Room:</h4>
                    <p className="shopDownMain">The plastic cylinder planters come with a plastic stand to help elevate your plants off the ground. The plastic cylinder planters come with a plastic stand to help elevate your plants off the ground. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
